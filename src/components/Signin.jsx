            ...
            <div className='flex flex-col gap-6 w-full h-full items-center'>
                ...
                <div className="flex justify-center gap-3 items-center flex-col w-full sm:w-3/4">
                    ...
                    <div className='flex justify-start items-center gap-5 font-bold sm:text-5xl text-2xl w-3/4 sm:m-20 m-10 sm:ps-5 sm:mb-5 mb-2 '>
                        ...
                        <div className='sm:h-14 sm:w-14 h-10 w-10 motion-translate-x-in-[0%] motion-translate-y-in-[-100%]'><img src="https://cdn-icons-png.flaticon.com/512/295/295128.png" alt="" className='w-full h-full' /></div>
                    </div>
                    ...
                    <div className="m-3 motion-translate-x-in-[0%] motion-translate-y-in-[100%]">Don't have an account? <Link to="/signup" className="text-decoration-none font-bold text-orange-500">Sign Up</Link></div>
