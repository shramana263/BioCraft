...
const DataPreview = () => {
    ...
    return (
        <>
            <div className='flex w-full h-full border rounded flex-col gap-5 p-3'>
                    ...
                    <div className='flex flex-col gap-4'>
                        {
                            educationalData && educationalData.map((item, index) => (
                                <div key={index} className='border rounded p-3'>
                                    ...
                                    <div>
                                        <span className='font-bold'>Year of Passing : </span> <span>{item.passing}</span>
                                    </div>
                                    {
            ...
            <div className='flex w-full justify-end items-end p-3'>
